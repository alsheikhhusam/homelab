...
{{/*
Short digest of the browser assets, substituted into the asset URLs in
glance.yml so a changed script busts the browser cache on its own.
*/}}
{{- define "glance.assetsVersion" -}}
{{- include (print .Template.BasePath "/assets-configmap.yaml") . | sha256sum | trunc 8 -}}
{{- end }}
